...
@section('content')
    ...
    <body>
        ...
        <div class="border">
            ...
            <a href="{{ route('tags.create') }}" class="topi_create btn btn-outline-success">Thêm mới</a>
            <table class="top">
                <tr>
                    <th>STT</th>
                    <th>Tên thẻ</th>
                ...
                @foreach ($tags as $item => $tag)
                    <tr>
                        ...
                        <td>{{ $tag->name }}</td>
                        <td>
                            @if ($tag->status == 'Còn hàng')
                                <span class="badge badge-success">{{ $tag->status }}</span>
                            @else
                                <span class="badge badge-danger">{{ $tag->status }}</span>
                        </td>
                @endif
                <td>
                    <div class="icon-wrapper">
                        @if (Auth::user()->hasPermission('tags.edit'))
                            <a href="{{ route('tags.edit', $tag->id) }}" class="edit-icon"><i
                                    class="fa-solid fa-pen-to-square"></i></a>
                            @if (Auth::user()->hasPermission('tags.destroy'))
