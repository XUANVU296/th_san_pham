        ...
        <div class="container">
            <div class="row col-12">
                <div class="col-6">
                    ...
                    <input type="text" id="fname" name="name" class="form-control" value="{{ $tags->name }}">
                    @error('name')
                ...
                <div class="col-5">
                    ...
                    <select name="status" id="lname" class="form-control">
                        <option value="Còn hàng" <?php echo $tags->status == 'Còn hàng' ? 'selected' : ''; ?>>Còn hàng</option>
                        <option value="Hết hàng" <?php echo $tags->status == 'Hết hàng' ? 'selected' : ''; ?>>Hết hàng</option>
                    </select>
                    @error('status')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
